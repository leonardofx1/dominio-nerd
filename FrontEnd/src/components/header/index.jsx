...
import { BiCartAdd, BiUserCircle } from "react-icons/bi";
          ...
          {showMenu ? (
            ...
            <CgMenuRound>
              <C.Menu showMenu={showMenu}>
                ...
                <C.ItemMenu>Sobre o jogo</C.ItemMenu>
                <C.ItemMenu>Produtos</C.ItemMenu>
      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <Link style={{ textDecoration: "none" }} to="/login">
          ...
          >
            ...
            <p style={{ marginTop: ".5rem" }}>Entrar / Cadastrar</p>
          </div>
        </Link>
      </div>
    </C.Nav>
